...
public class GameWindow extends JPanel{
    ...
    int holder=0;//hold the index of record
    ...
    public void main() throws Exception{
       ...
       for(int i=0;i<framelength;i+=framelimit){
          ...
          ////can not use for loop due to linklist will be null whne it is empty
          if(allow[0]&&key[0]){
             if(!test0.isEmpty()&&test0.peekFirst()!=null&&test0.get(0).getY()>=400&&test0.get(0).getY()-400<=20){
          ...
          if(allow[1]&&key[1]){
             if(!test1.isEmpty()&&test1.peekFirst()!=null&&test1.get(0).getY()>=400&&test1.get(0).getY()-400<=20){
                 System.out.println("hit");
          ...
          if(allow[2]&&key[2]){
             if(!test2.isEmpty()&&test2.peekFirst()!=null&&test2.get(0).getY()>=400&&test2.get(0).getY()-400<=20){
                 System.out.println("hit");
          ...
          if(allow[3]&&key[3]){
             if(!test3.isEmpty()&&test3.peekFirst()!=null&&test3.get(0).getY()>=400&&test3.get(0).getY()-400<=20){
                 System.out.println("hit");
